...
Then, have what looks like a database web-console on port 8082. A quick google search reveals that [H2](https://en.wikipedia.org/wiki/H2_(database)) is a relational database system written in Java. We will take a look at this servie later on.
