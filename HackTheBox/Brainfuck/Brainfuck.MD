...
So instead, I tried to upload a malicious plugin that I created, which had a reverse shell payload embedded inside. But the plugin upload feature has been disabled comepletly!  
