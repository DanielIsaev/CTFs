...
lets perfrom directory busting. For this task lets use `fwuzz`
...
This will send 100 â€˜Aâ€™ characters to the server's buffer, incrementing it by 100 every iteration 
...
register and we should get the exact location of the offset: 
...
We need to identify any characters that may cause any issues to our target program,
